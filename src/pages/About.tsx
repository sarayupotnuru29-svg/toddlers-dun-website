...
import builderChild from "@/assets/about.png";
          ...
          <div className="grid grid-cols-2 max-lg:grid-cols-1 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-foreground/80 leading-relaxed mb-4">
                Toddlers Den is India's premier community-focused daycare solution provider. We partner with builders and housing communities to create custom, on-site childcare centers that meet the highest standards of safety and care.
              </p>
              <p className="text-lg text-foreground/80 leading-relaxed">
                Our mission is simple: make quality childcare accessible to every family, right where they live.
              </p>
            </div>
            {/* Extended Image Size Container */}
            <div className="flex justify-center items-center animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <img
                src={builderChild}
                alt="Builder and child"
                className="w-full max-w-lg h-auto rounded-3xl shadow-xl animate-float object-cover"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 max-md:py-16 section-gradient">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-lg text-foreground/80 leading-relaxed mb-8">
            Every child deserves a safe, nurturing environment to grow and learn. Every parent deserves peace of mind. And every community thrives when families are supported. Toddlers Den exists to make this vision a reality—one community at a time.
          </p>
        </div>
      </section>
